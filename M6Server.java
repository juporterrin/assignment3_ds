...
public class M6Server {
    ...
    static void startServer() {
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            System.out.println("M6's server started on port " + PORT);
        ...
        public void run() {
            try (
                ...
                try {
                    Thread.sleep(delay);
                    if(delay != 0) {
                        System.out.println("M6 delaying.....");
                    }
                ...
                if(sequenceNumber > maxSequenceNumber ){
                    ...
                    sendVoteToLearner("M6Vote","I am M6, I vote for " + proposer,proposer);
                }else{
