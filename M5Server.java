...
public class M5Server {
    ...
    static void startServer() {
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            System.out.println("M5's server started on port " + PORT);
        ...
        public void run() {
            try (
                ...
                try {
                    Thread.sleep(delay);
                    if(delay != 0) {
                        System.out.println("M5 delaying.....");
                    }
                ...
                if(sequenceNumber > maxSequenceNumber ){
                    ...
                    sendVoteToLearner("M5Vote","I am M5, I vote for " + proposer,proposer);
                }else{
