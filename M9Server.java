...
public class M9Server {
    ...
    static void startServer() {
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            System.out.println("M9's server started on port " + PORT);
        ...
        public void run() {
            try (
                ...
                try {
                    Thread.sleep(delay);
                    if(delay != 0) {
                        System.out.println("M9 delaying.....");
                    }
                ...
                if(sequenceNumber > maxSequenceNumber ){
                    ...
                    sendVoteToLearner("M9Vote","I am M9, I vote for " + proposer,proposer);
                }else{
