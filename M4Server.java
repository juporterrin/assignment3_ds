...
public class M4Server {
    ...
    static void startServer() {
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            System.out.println("M4's server started on port " + PORT);
        ...
        public void run() {
            try (
                ...
                try {
                    Thread.sleep(delay);
                    if(delay != 0) {
                        System.out.println("M4 delaying.....");
                    }
                ...
                if(sequenceNumber > maxSequenceNumber ){
                    ...
                    sendVoteToLearner("M4Vote","I am M4, I vote for " + proposer,proposer);
                }else{
