...
public class M8Server {
    ...
    static void startServer() {
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            System.out.println("M8's server started on port " + PORT);
        ...
        public void run() {
            try (
                ...
                try {
                    Thread.sleep(delay);
                    if(delay != 0) {
                        System.out.println("M8 delaying.....");
                    }
                ...
                if(sequenceNumber > maxSequenceNumber ){
                    ...
                    sendVoteToLearner("M8Vote","I am M8, I vote for " + proposer,proposer);
                }else{
